...
?>
  ...
  <script>
    ...
    <form class="d-flex">
      <input class="form-control me-2" type="text" id="mekletajs" placeholder="Meklēt..." 
          onkeyup="meklet(this.value)">
    </form>
    <?php } ?>
    
    <a href="index.php?atvert=veikals" class="nav_saite"><button class="btn btn-warning" type="button">Veikals</button></a>
    <?php
    ...
    if(pieteicies()) { ?>
      ...
      <a href="admin/index.php" class="nav_saite"><button class="btn btn-primary" type="button">Administrācijas panelis</button></a>
      <?php } ?>

    <?php 
    } else { ?>
      <a href="login.php" class="nav_saite"><button class="btn btn-primary" type="button">Pieteikties</button></a>
    <?php 
    } ?>
